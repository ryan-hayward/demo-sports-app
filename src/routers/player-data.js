...
const getPlayerGameLog = require('../spawn-python') //get player game log from spawn-python

router.get('/', (req, res, next) => {
    res.send("Router Working")
})

router.get('/playerdata', (req, res, next) => {
    //call get
    getPlayerGameLog("Aaron Rodgers", "QB", "2017", (gameLog) => {
        res.send(gameLog)
    })
})
